  ...
  <div class="wrapper ">
    ...
    <div class="main-panel">
     <?php include '../config/header.php'; ?>
      ...
      <td><a href="/thenewcart/dbadmin/assets/img/bill/<?php echo $row['pic']; ?>" target="_blank"><img height="70" width="70" src="/thenewcart/dbadmin/assets/img/bill/<?php echo $row['pic']; ?>" border="0"></a></td>
      </tr>
      <?php 
      }?>
