...
<body>
      ...
      <div class="container">
        ...
        <div class="collapse navbar-collapse" id="navbarResponsive">
          <ul class="navbar-nav ml-auto mr-auto">
            ...
            <li class="nav-item active"><a class="nav-link" href="cars.php">ซื้อรถ<span class="sr-only">(current)</span></a></li>
  ...
  <!-- Page Content -->
  <div class="" 
  style="background-image: url(assets/images/banner/Banner_Sale.png);
  ...
  <div class="products" style="background-color: #F0F8FF; padding-top: 30px;
  padding-bottom: 30px;">
    <div class="container">
      <div class="row">
        <div class="col-md-3">
            ...
            <div class="col-md-6">
              <div class="product-item">
                ...
                <div class="down-content">
                  ...
                  <a href="cars.html" class="filled-button1">ดูเพิ่มเติม</a>
                </div>
              </div>
            </div>
